    ...
    <div ref={setNodeRef} style={dragStyle}>
      ...
      >
        ...
        {folderVideos.length > 0 && !isRenaming && (
          <span className={cn("text-muted-foreground opacity-60 shrink-0", textClasses.badgeText)}>
            {folderVideos.length}
          </span>
        )}
        ...
        {!isRenaming && (
          <button
            className="p-0.5 rounded-sm opacity-0 group-hover:opacity-100 hover:bg-accent transition-opacity shrink-0 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
