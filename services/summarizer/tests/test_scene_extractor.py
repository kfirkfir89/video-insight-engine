...
class TestExtractSceneKeyframes:
    ...
    async def test_returns_empty_on_ytdlp_timeout(self, mock_exec, mock_settings, mock_s3, mock_check):
        mock_settings.SCENE_EXTRACTION_ENABLED = True
    ...
    @patch("asyncio.create_subprocess_exec")
    async def test_returns_empty_on_ytdlp_failure(self, mock_exec, mock_tempfile, mock_settings, mock_s3, mock_check):
        mock_settings.SCENE_EXTRACTION_ENABLED = True
        mock_settings.SCENE_THRESHOLD = 0.3
